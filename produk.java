    ...
    public static void tampilkan(Boolean navigasi) {
        ...
        try (ResultSet rs = util.koneksiDB().createStatement().executeQuery(sql)) {
            ...
            // Jika data kosong, tampilkan pesan khusus
                System.out.println("Data Produk Kosong. Silahkan isi data produk terlebih dahulu.");
            } else {
...
class kategoriProduk {
    ...
    // migration : Method untuk membuat tabel kategori produk
    public static void buatTabel() {
        String sql = ""
    ...
    // seeder : Method untuk Membuat Data Kategori Awal
    public static void buatDataAwal() {
        String sql = ""
    ...
    public static void tampilkan(Boolean navigasi) {
        ...
        try (ResultSet rs = util.koneksiDB().createStatement().executeQuery(sql)) {
            ...
            if (list.isEmpty()) {
            // Jika data kosong, tampilkan pesan khusus
                System.out.println("Data Kategori Produk Kosong. Silahkan isi data produk terlebih dahulu.");
            } else {
                util.tampilkanData(list);
            }
